# BWA-KMeter — read before doing anything

> ✅ **This is the CANONICAL home for BWA-KMeter.** All serious DSP, IP, and
> process for this plugin live **here**, in `~/Developer/BWA-KMeter/`. Author here — always.
>
...
> changes. This file deliberately holds only what is specific to BWA-KMeter; every
...
4. **`docs/MARKET-PAIN-AND-ATTACKS.md`** — the row for **BWA-KMeter**; internalize the pain + attack before any DSP.
...
Then cut a GitHub Release here (`vmcguire/BWA-KMeter`) and attach the notarized `BWA-KMeter.vst3`.
