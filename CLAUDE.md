...
> Do all work in the monorepo: **`~/Developer/bwa-fx-ecosystem/BWA-KMeter/`**
...
```bash
git subtree push --prefix=BWA-KMeter git@github.com:vmcguire/BWA-KMeter.git main
```

Then cut a GitHub Release in this mirror and attach the notarized `BWA-KMeter.vst3`.
